...
@NamedQueries({
    ...
    @NamedQuery(name = "Citas.findByCedula", query = "SELECT c FROM Citas c WHERE c.cedula = :cedula"),
    @NamedQuery(name = "Citas.findByFecha", query = "SELECT c FROM Citas c WHERE c.fecha = :fecha"),
    @NamedQuery(name = "Citas.findByMedico", query = "SELECT c FROM Citas c WHERE c.medico = :medico")})
public class Citas implements Serializable {
    ...
    public Citas(Integer id, int cedula) {
        this.id = id;
        this.cedula = cedula;
    }
